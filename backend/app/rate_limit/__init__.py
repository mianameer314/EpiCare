...
LOGIN_LIMIT = RateLimit(prefix="login", limit=5, window_seconds=60, fail_closed=True)
REGISTER_LIMIT = RateLimit(prefix="register", limit=3, window_seconds=60, fail_closed=True)
REFRESH_LIMIT = RateLimit(prefix="refresh", limit=20, window_seconds=60, fail_closed=True)
...
SOS_LIMIT = RateLimit(prefix="sos", limit=5, window_seconds=60, fail_closed=True)
...
OTP_LIMIT = RateLimit(prefix="otp", limit=5, window_seconds=600, fail_closed=True)
